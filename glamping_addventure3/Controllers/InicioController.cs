...
using glamping_addventure3.Models.glamping_addventure3.Models.ViewModels;
...
namespace glamping_addventure3.Controllers
{
    ...
    public class InicioController : Controller
    {
        ...
        // Constructor único que permite inyección de dependencias
        public InicioController(GlampingAddventure3Context context, IUsuarioService usuarioService)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _usuarioServicio = usuarioService ?? throw new ArgumentNullException(nameof(usuarioService));
        }
            ...
            var ciudades = new Dictionary<string, List<string>>
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            var usuario = await _context.Usuarios
                .FirstOrDefaultAsync(u => u.Email == model.CorreoElectronico && u.Contrasena == model.Contraseña);
